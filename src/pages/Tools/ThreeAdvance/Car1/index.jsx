...
function Model(props) {
  const { scene, nodes, materials } = useGLTF('/assets/car/lambo.glb')
  ...
  return (
    <Canvas dpr={[1, 2]} shadows camera={{ fov: 45 }}>
      ...
      <Suspense fallback={<Loader/>}>
        ...
        <Stage environment={null} preset="rembrandt" intensity={1.5} contactShadowOpacity={1} shadowBias={-0.0015}>
          <Model scale={0.01} />
        </Stage>
      </Suspense>
